...
%% Time-stamp: <2013-05-15 Wed 09:45 emilio on emilio-despacho>
%% =====================================================================
...
If the XKCD fonts, or other fonts, are not installed in the system, you may follow the tutorial 
\href{http://fibosworld.wordpress.com/2013/02/17/change-fonts-in-ggplot2-and-create-xkcd-style-graphs/}{\textit{Change fonts in ggplot2, and create xkcd style graphs}}
to install them. 

Or read the documentation of the package \texttt{extrafont}, with detailed instructions in \url{https://github.com/wch/extrafont}: 
\begin{itemize}
    \item Option I:
<<eval=FALSE>>=
## Borrowed from
...
@ 
    \item Option II. The first option does not work for me (on a Linux machine). I installed the fonts in this way:
<<eval=FALSE>>=
library(extrafont)
...
If you want to uninstall the fonts, you may remove the following packages:
<<eval=FALSE>>=
...
<<CaritasSpain,fig=TRUE,eval=TRUE>>=
